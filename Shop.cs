...
public class Shop : MonoBehaviour
{
    ...
    public void RandomReward()
    {
        ...
        int randomIndex3 = indices[3];
        int randomIndex4 = indices[4];
        int randomIndex5 = indices[5];
        int randomIndex6 = indices[6];
        int randomIndex7 = indices[7];
        ...
        InstantiateAndSetParent(randomIndex3);
        InstantiateAndSetParent(randomIndex4);
        InstantiateAndSetParent(randomIndex5);
        InstantiateAndSetParent(randomIndex6);
        InstantiateAndSetParent(randomIndex7);
    }
